...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .price  { font-size: 2.25rem; font-weight: 800; letter-spacing: -0.03em; margin: 0.75rem 0 1.25rem; }
    ...
    button:disabled { background: #bbb; cursor: not-allowed; opacity: 1; }
  ...
  <div class="card">
    ...
    ${online
      ? `<p class="hint">Tap to pay — fridge unlocks instantly</p>
         <button id="payBtn">Pay ${PRICE_DISPLAY()}</button>
