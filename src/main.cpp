...
const char* WIFI_SSID  = "CenturyLink8264";
const char* WIFI_PASS  = "43dcevc8c6feee";
const char* MQTT_HOST  = "a57e6240bbfd4781b4ff3f4d6e1d18e4.s1.eu.hivemq.cloud";
const int   MQTT_PORT  = 8883;
const char* MQTT_USER  = "onigiri-fridge";
const char* MQTT_PASS  = "YTgjJEMmqKJ6";
...
void onMqttMessage(char* topic, byte* payload, unsigned int length) {
  ...
  // Simple string match -- no HMAC yet (Stage 3 adds that)
...
void setup() {
  ...
  wifiClient.setInsecure();  // no cert pinning yet -- Stage 3 adds this
